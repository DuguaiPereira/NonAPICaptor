...
1. **Download the Installer:**
   - [Click here to download the installer "24-hour format" (NonAPICaptor.exe)](https://github.com/DuguaiPereira/NonAPICaptor/releases/download/v1.0.0/NonAPICaptor.exe)
